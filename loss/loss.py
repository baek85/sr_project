...
class Adversarial(nn.Module):
    def __init__(self, args, gan_type):
        ...
        self.optimizer = optim.Adam(self.dis.parameters(), lr=args.lr, betas=(0, 0.9))
        milestones = [100, 300, 500]
        self.scheduler = optim.lr_scheduler.MultiStepLR(self.optimizer, milestones=milestones, gamma=args.gamma)
